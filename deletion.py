...
myrequests = requests.get("https://developer.nrel.gov/api/alt-fuel-stations/v1/nearest.json?api_key=txjtl74e5DqZ9UH0hjCacIGLtWDajB5RLcmnx9x2&location=Denver+CO")
datajson = myrequests.json()

ofile = open("delete_api","w")
ofile.write("<h1>" + datajson['latitude']+ "</h1>")
ofile.close()
#parsing is finding what you need
...
#Remeber to put windows and widgets!
